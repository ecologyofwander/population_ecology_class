...
#Answer: 
#THERE'S 130 SURVEYS, 2 YEARS.
#It's just two years of data, that's not great
...
## PERHAPS FOREST AND SHRUBS ARE CORRELATED. 
###
...
# Answer:
#We want to see the spread of the predicator variables. We can do this with a histogram. Grass and forest seem not well spread out.
