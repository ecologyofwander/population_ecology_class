...
# Answer:TIME SEEMS TO BE MOST IMPORTANT IN DETECTION, SAGEBRUSH SEEMS TO BE THE MOST IMPORTANT PREDICTOR IN STATE.
#
...
# Answer: THERE IS A SIGNIFICANT DIFFERENCE BETWEEN THE MODEL AND THE OBSERVED DATA.
#
...
# Answer:THE FULL MODEL HAS THE SMALLER AIC SCORE.
#
...
# Answer: TIME AND TIME2 SEEMED TO BE OVERDISPERSED, WHERE AS SAGEBRUSH IS NOT.
#
...
# Answer: THEY ARE IMPORTANT FOR DETECTING OVERDISPERSION IN YOUR MODEL, WHICH TIME SEEMS TO BE.
#
...
# Answer: BOTH SEEM TO BE WITHIN THE LINE WITH ONLY SOME DEVIATION IN SITE-SUM.
# 
...
# Answer: ONE SHOULD GRAPHICALLY DISPLAY YOUR RESIDENTIALS TO DETECT OVERDISPERSION.
#
...
# Answer: I CAN'T GET THE NEGATIVE BINOMIAL FAMILY TO RUN PROPERLY.
#
