...
obs_df <- read.csv(here("data","obs_df.csv"))
#view
head( obs_df ); dim(obs_df)
#load predictor data
preddf <- read.csv(here("data","predictors.csv"))
#view
...
write.csv(closeddf, file = here("data", "closedf.csv"), row.names = FALSE)


write.csv(opendf, file = here("data", "opendf.csv"), row.names = FALSE)
