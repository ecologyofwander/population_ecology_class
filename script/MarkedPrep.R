...
# Answer:
#YES, DIFFERENT SITES HAVE DIFFERENT SITE RATIOS.
...
# Answer:
# HUGE REDUCTION IN NUMBERS IN 2022 AND 2023, EXCEPT AT ONE SITE.
...
# answer:
#THERE SEEMS TO BE AN EVEN SPREAD OF WIND AND TEMP.
